...
from models.imagenet.seesaw import seesawnet
from models.imagenet.seesaw_half import seesawnet_half
...
parser.add_argument('--arch', '-a', metavar='ARCH', default='seesaw',
                    choices=model_names,
...
parser.add_argument('--epochs', default=480, type=int, metavar='N',
                    help='number of total epochs to run')
parser.add_argument('--start-epoch', default=0, type=int, metavar='N',
                    help='manual epoch number (useful on restarts)')
parser.add_argument('--train-batch', default=96, type=int, metavar='N',
                    help='train batchsize (default: 256)')
parser.add_argument('--test-batch', default=196, type=int, metavar='N',
...
# Checkpoints
parser.add_argument('-c', '--checkpoint', default='./workspace', type=str, metavar='PATH',
...
def main():
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        }, is_best, checkpoint=args.checkpoint, filename=str(epoch)+'th_epoch_checkpoint.pth.tar')
